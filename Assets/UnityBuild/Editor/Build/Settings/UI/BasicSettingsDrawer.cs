...
public class BasicSettingsDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (show)
        {
            ...
            SerializedProperty showNotification = property.FindPropertyRelative("showNotification");
            showNotification.boolValue = EditorGUILayout.ToggleLeft(" Show notification", showNotification.boolValue);
