...
public static class BuildProject
{
    ...
    private static void PerformBuild(string[] buildConfigs, BuildOptions options = BuildOptions.None)
    {
        ...
        if (BuildSettings.basicSettings.showNotification)
        {
            //System.Diagnostics.Process.Start(BuildSettings.basicSettings.baseBuildFolder);
            EditorUtility.DisplayDialog("SuperUnityBuild", "The build process is complete, check the log for more details.\n\nSuccessful builds: " + successCount + "\nFailed builds: " + failCount, "OK");
        }
    }
